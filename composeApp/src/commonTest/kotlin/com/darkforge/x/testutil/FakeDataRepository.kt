package com.darkforge.x.testutil

import com.darkforge.x.data.Conversation
import com.darkforge.x.data.DataRepository
import com.darkforge.x.data.EmailAccount
import com.darkforge.x.data.EmailSyncState
import com.darkforge.x.data.FallbackStatus
import com.darkforge.x.data.FreeMode
import com.darkforge.x.data.HeartbeatConfig
import com.darkforge.x.data.HeartbeatLogEntry
import com.darkforge.x.data.ImportSection
import com.darkforge.x.data.MemoryEntry
import com.darkforge.x.data.ScheduledTask
import com.darkforge.x.data.Service
import com.darkforge.x.data.ServiceEntry
import com.darkforge.x.data.ServiceInstance
import com.darkforge.x.data.SmsDraft
import com.darkforge.x.data.SmsSyncState
import com.darkforge.x.data.SystemPromptVariant
...
class FakeDataRepository : DataRepository {
    ...
    override suspend fun ask(
        ...
        uiSubmission: com.darkforge.x.data.UiSubmission?,
    ...
    var skills: List<com.darkforge.x.skills.SkillManifest> = emptyList()

    override fun getInstalledSkills(): List<com.darkforge.x.skills.SkillManifest> = skills
    override suspend fun uninstallSkill(id: String) {}
    override suspend fun browseSkillMarketplaces(): Result<List<com.darkforge.x.skills.RegistrySkillEntry>> = Result.success(emptyList())
    override suspend fun installBrowsedSkill(entry: com.darkforge.x.skills.RegistrySkillEntry): Result<com.darkforge.x.skills.SkillManifest> = Result.failure(NotImplementedError())
    override suspend fun installGitHubSkill(owner: String, repo: String, ref: String, path: String): Result<com.darkforge.x.skills.SkillManifest> = Result.failure(NotImplementedError())
    ...
    override fun getNotificationSyncState(): com.darkforge.x.data.NotificationSyncState = com.darkforge.x.data.NotificationSyncState()
