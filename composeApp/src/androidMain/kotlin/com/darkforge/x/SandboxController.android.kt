...
import com.darkforge.x.sandbox.SessionShell
import com.darkforge.x.sandbox.openFileWithIntent
import com.darkforge.x.sandbox.resolveSandboxAbsolute
...
class AndroidSandboxController : SandboxController {
    ...
    override fun transcriptFor(sessionId: String): SnapshotStateList<com.darkforge.x.TerminalLine> = sandboxManager.transcriptFor(sessionId)
