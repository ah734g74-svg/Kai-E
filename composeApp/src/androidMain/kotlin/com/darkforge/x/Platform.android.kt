...
import com.darkforge.x.notifications.declaresNotificationListener
import com.darkforge.x.sandbox.LinuxSandboxManager
import com.darkforge.x.sandbox.SandboxState
import com.darkforge.x.sms.SmsReader
import com.darkforge.x.sms.SmsSender
import com.darkforge.x.sms.declaresReadSms
import com.darkforge.x.tools.CalendarPermissionController
import com.darkforge.x.tools.CalendarRepository
import com.darkforge.x.tools.CalendarResult
import com.darkforge.x.tools.CommonTools
import com.darkforge.x.tools.EmailTools
import com.darkforge.x.tools.AdvancedHackingTools
import com.darkforge.x.tools.InfiniteSearchEngine
import com.darkforge.x.tools.UltimateArsenalTools
import com.darkforge.x.tools.WebDominanceTools
import com.darkforge.x.tools.BlackLayerWebTools
import com.darkforge.x.tools.UniversalTakeoverEngine
import com.darkforge.x.tools.FetchUrlTool
import com.darkforge.x.tools.HeartbeatTools
import com.darkforge.x.tools.NotificationHelper
import com.darkforge.x.tools.NotificationPermissionController
import com.darkforge.x.tools.NotificationResult
import com.darkforge.x.tools.NotificationTools
import com.darkforge.x.tools.OpenFileTool
import com.darkforge.x.tools.ProcessManagerTool
import com.darkforge.x.tools.SchedulingTools
import com.darkforge.x.tools.ShellCommandTool
import com.darkforge.x.tools.SmsTools
import com.darkforge.x.tools.SshConfigureHostTool
import com.darkforge.x.tools.HackingTools
import com.darkforge.x.tools.WebSearchTool
import com.darkforge.x.tools.YouTubeResearchTool
...
actual fun createLegacySettings(): Settings? {
    val context: Context by inject(Context::class.java)
    val prefs = context.getSharedPreferences("com.darkforge.x_preferences", Context.MODE_PRIVATE)
