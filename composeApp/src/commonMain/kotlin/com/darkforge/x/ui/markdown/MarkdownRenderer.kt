package com.darkforge.x.ui.markdown
...
import com.darkforge.x.ui.markdown.math.MathFormula
...
fun MarkdownContent(
    ...
    val doc = remember(content) {
        runCatching { parseMarkdown(content) }.getOrElse {
            MarkdownDocument(persistentListOf(Paragraph(persistentListOf(com.darkforge.x.ui.markdown.Text(content)))))
        }
    }
