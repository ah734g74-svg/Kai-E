package com.darkforge.x.notifications

import com.darkforge.x.data.NotificationRecord
 ...
 *
 * Unlike [com.darkforge.x.sms.SmsReader] which queries the system content
 * provider, this reads from the in-process [com.darkforge.x.data.NotificationStore]
