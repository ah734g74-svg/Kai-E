...
/**
 * Persistence for notifications captured by [com.darkforge.x.notifications.KaiNotificationListenerService].
 *
 * Two collections:
 ...
 * - **Store** — broader rolling history backing [com.darkforge.x.notifications.NotificationReader],
